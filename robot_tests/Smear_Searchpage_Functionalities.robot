...
#Select Värriö, Aerosol, Particle concentration, Click "Plot", check that correct graph appears.
    ...
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[1]/ul/li[1]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[1]/ul/li[1]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[1]/ul/li[1]/ul/li[1]/div/span[contains(text(),'Particle concentration')]
...
#Select Värriö, Gas, NO concentration 9 m and O3 concentration 9 m, Click "Plot", check that correct graphs appear.
    ...
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[1]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[1]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[1]/ul/li[2]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[1]/ul/li[2]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[1]/ul/li[2]/ul/li[2]/div/span[contains(text(),'NO concentration 9 m')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[1]/ul/li[2]/ul/li[2]/div/span[contains(text(),'NO concentration 9 m')]	
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[1]/ul/li[2]/ul/li[10]/div/span[contains(text(),'O3 concentration 9 m')]
...
#Select Värriö, Meteorology, Wind speed 16 m, Click "Plot", check that correct graph appears.
    ...
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[1]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[1]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[1]/ul/li[3]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[1]/ul/li[3]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[1]/ul/li[3]/ul/li[3]/div/span[contains(text(),'Wind speed 16 m')]
...
#Select Värriö, Radiation, UVA radiation and UVB radiation, Click "Plot", check that correct graphs appear.
    ...
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[1]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[1]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[1]/ul/li[4]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[1]/ul/li[4]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[1]/ul/li[4]/ul/li[5]/div/span[contains(text(),'UVA radiation')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[1]/ul/li[4]/ul/li[5]/div/span[contains(text(),'UVA radiation')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[1]/ul/li[4]/ul/li[6]/div/span[contains(text(),'UVB radiation')]
...
#Select Värriö, Soil, Soil temperature 10 cm, Click "Plot", check that correct graph appears.
    ...
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[1]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[1]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[1]/ul/li[5]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[1]/ul/li[5]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[1]/ul/li[5]/ul/li[4]/div/span[contains(text(),'Soil temperature 10 cm')]
...
#Select Värriö, Tree, H2O in shoot chamber 0 and H2O in shoot chamber 1, Click "Plot", check that correct graphs appear.
    ...
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[1]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[1]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[1]/ul/li[6]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[1]/ul/li[6]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[1]/ul/li[6]/ul/li[6]/div/span[contains(text(),'H2O in shoot chamber 0')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[1]/ul/li[6]/ul/li[6]/div/span[contains(text(),'H2O in shoot chamber 0')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[1]/ul/li[6]/ul/li[12]/div/span[contains(text(),'H2O in shoot chamber 1')]
...
#Select Värriö, Flux, CO2 flux, Click "Plot", check that correct graph appears.
    ...
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[1]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[1]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[1]/ul/li[7]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[1]/ul/li[7]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[1]/ul/li[7]/ul/li[7]/div/span[contains(text(),'CO2 flux')]
...
#Select Värriö, Flux ancillary data, Air temperature, Click "Plot", check that correct graph appears.
    ...
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[1]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[1]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[1]/ul/li[8]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[1]/ul/li[8]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[1]/ul/li[8]/ul/li[10]/div/span[contains(text(),'Air temperature')]
...
#Select Hyytiälä, Flux, Sensible heat storage flux, Click "Plot", check that correct graph appears.
    ...
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[2]/ul/li[1]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[2]/ul/li[1]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[2]/ul/li[1]/ul/li[1]/div/span[contains(text(),'Sensible heat storage flux')]
...
#Select Hyytiälä, Flux, Latent heat storage flux, Click "Plot", check that correct graph appears.
    ...
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[2]/ul/li[1]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[2]/ul/li[1]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[2]/ul/li[1]/ul/li[2]/div/span[contains(text(),'Latent heat storage flux')]
...
#Select Hyytiälä, Radiation, Global radiation 67 m, Click "Plot", check that correct graph appears.
    ...
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[2]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[2]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[2]/ul/li[6]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[2]/ul/li[6]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[2]/ul/li[6]/ul/li[1]/div/span[contains(text(),'Global radiation 67 m')]
...
#Select Hyytiälä, Soil, Soil surface temperature (ICOS), Click "Plot", check that correct graph appears.
    ...
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[2]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[2]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[2]/ul/li[7]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[2]/ul/li[7]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[2]/ul/li[7]/ul/li[1]/div/span[contains(text(),'Soil surface temperature (ICOS)')]
...
#Select Hyytiälä, Soil, Soil temperature A (ICOS), Click "Plot", check that correct graph appears.
    ...
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[2]/ul/li[7]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[2]/ul/li[7]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[2]/ul/li[7]/ul/li[2]/div/span[contains(text(),'Soil temperature A (ICOS)')]
...
#Select Hyytiälä, Soil, Soil temperature B1 (ICOS), Click "Plot", check that correct graph appears.
    ...
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[2]/ul/li[7]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[2]/ul/li[7]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[2]/ul/li[7]/ul/li[3]/div/span[contains(text(),'Soil temperature B1 (ICOS)')]
...
#Select Hyytiälä, Soil, Soil temperature B2 (ICOS), Click "Plot", check that correct graph appears.
    ...
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[2]/ul/li[7]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[2]/ul/li[7]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[2]/ul/li[7]/ul/li[4]/div/span[contains(text(),'Soil temperature B2 (ICOS)')]
...
#Select Hyytiälä, Soil, Soil temperature C (ICOS), Click "Plot", check that correct graph appears.
    ...
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[2]/ul/li[7]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[2]/ul/li[7]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[2]/ul/li[7]/ul/li[5]/div/span[contains(text(),'Soil temperature C (ICOS)')]
...
#Select Hyytiälä, Soil, Soil temperature C2 (ICOS), Click "Plot", check that correct graph appears.
    ...
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[2]/ul/li[7]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[2]/ul/li[7]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[2]/ul/li[7]/ul/li[6]/div/span[contains(text(),'Soil temperature C2 (ICOS)')]
...
#Select Kumpula, Gas, CO concentration, Click "Plot", check that correct graph appears.
    ...
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[3]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[3]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[3]/ul/li[2]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[3]/ul/li[2]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[3]/ul/li[2]/ul/li[5]/div/span[contains(text(),'CO concentration')]
...
#Select Kumpula, Meteorology, Relative humidity, Click "Plot", check that correct graph appears.
    ...
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[3]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[3]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[3]/ul/li[3]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[3]/ul/li[3]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[3]/ul/li[3]/ul/li[3]/div/span[contains(text(),'Relative humidity')]
...
#Select Kumpula, Meteorology, Snowfall, Click "Plot", check that correct graph appears.
    ...
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[3]/ul/li[3]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[3]/ul/li[3]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[3]/ul/li[3]/ul/li[13]/div/span[contains(text(),'Snowfall')]
...
#To get some data from Puijo date has to be from the year 2016.
    ...
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[4]/ul/li[1]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[4]/ul/li[1]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[4]/ul/li[1]/ul/li[1]/div/span[contains(text(),'Matlab time')]
...
#Select Erottaja, Flux, Sensible heat flux, Click "Plot", check that correct graph appears(?).
    ...
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[5]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[5]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[5]/ul/li[1]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[5]/ul/li[1]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[5]/ul/li[1]/ul/li[1]/div/span[contains(text(),'Sensible heat flux')]
...
#Select Torni, Flux, Wind speed, Click "Plot", check that correct graph appears.
    ...
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[6]/ul/li[2]/div/a[contains(text(),'►')]
...
#Select Siikaneva 1, Meteorology, Rainfall, Click "Plot", check that correct graph appears.
    ...
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[7]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[7]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[7]/ul/li[3]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[7]/ul/li[3]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[7]/ul/li[3]/ul/li[1]/div/span[contains(text(),'Rainfall')]
...
#To get some data from Siikaneva 2 date has to be from the year 2017.
    ...
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[8]/ul/li[4]/div/a[contains(text(),'►')]
    Click Element                       xpath=//*[@id="tree"]/ul/li[8]/ul/li[4]/div/a[contains(text(),'►')]
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[8]/ul/li[4]/ul/li[1]/div/span[contains(text(),'Net radiation')]
...
#Select Kuivajärvi, Water, Water temperature 1.0 m, Click "Plot", check that correct graph appears.
    ...
    Wait Until Element Is Visible       xpath=//*[@id="tree"]/ul/li[9]/ul/li[3]/div/a[contains(text(),'►')]
